...
# GNN imports (local)
from topoml.graphsage.models import SampleAndAggregate, SAGEInfo, Node2VecModel
from topoml.graphsage.minibatch import EdgeMinibatchIterator
...
class msc_gnn:
    ...
    def select_msc(self, train_or_test='', group_name='unnamed', bounds = [], write_json = False, write_msc = False, load_msc = 'test_ridge_arcs', cvt=tuple(), val_count=10):
        """
