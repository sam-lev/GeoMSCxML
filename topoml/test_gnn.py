...
gnn.train(train_prefix = train_group_name, embedding_name = embedding_name
          , load_walks=load_walks, learning_rate=learning_rate, epochs=epochs , weight_decay=weight_decay, polarity=polarity, depth=depth)
